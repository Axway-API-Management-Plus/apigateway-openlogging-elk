...
#### Community-Version
```
wget --no-check-certificate https://github.com/Axway-API-Management-Plus/apigateway-openlogging-elk/releases/download/v4.4.0/axway-apim-elk-v4.4.0.tar.gz -O - | tar -xvz
```
