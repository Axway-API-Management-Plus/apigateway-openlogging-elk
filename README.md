...
Therefore, the solution is __not suitable for a production__ environment __without further configuration__. For a production environment, check the parameters mentioned in the `env-sample` at the beginning and set them if necessary. 
