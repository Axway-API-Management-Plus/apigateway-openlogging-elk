...
describe('Endpoints', function () {
	...
	beforeEach(() => {
		// API-Builder project does not yet have implemented JMS
		// Simulate all responses in this test-file to be an admin
		// If an Admin wants to see JMS we return not implemented (501)
	...
	describe('Search', () => {
		it('[JMS-Search-0001] Execute a search on WebSockets as an admin which must return a 501', () => {
			return requestAsync({
				method: 'GET',
