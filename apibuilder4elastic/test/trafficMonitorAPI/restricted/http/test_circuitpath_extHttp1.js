...
describe('Traffic Monitor API Circuitpath - Ext-HTTP-AuthZ', function () {
	...
	describe('circuitpath endpoint tests', () => {
		it.only('[restricted-circuitpath-extHttpAuthZ-0001] Should return http 200 and (API Broker/HTTP Petstore) Policy with 2 filters as the transaction belongs to users organization', () => {
