...
describe('Traffic Monitor API', function () {
	...
	describe('Disabled User-AuthZ - Circuitpath endpoint tests', () => {
		it('[Disabled-AuthZ-circuitpath-0001] Should return http 200 and (API Broker/HTTP Petstore) Policy with 2 filters as user authorization is disabled', () => {
