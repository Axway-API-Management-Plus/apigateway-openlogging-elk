...
{{- $altNames := list ( printf "%s-elasticsearch" (include "apim4elastic.fullname" .) ) ( printf "%s-apibuilder4elastic" (include "apim4elastic.fullname" .) )  ( printf "%s-kibana" (include "apim4elastic.fullname" .) ) -}}
